...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V5.11 local sandbox simulation harness.")
    parser.add_argument("--scenario", default="full_fill")
    parser.add_argument("--ticks", type=int, default=100)
    args = parser.parse_args()

    result = generate_sandbox_simulation_report(scenario=args.scenario, max_ticks=args.ticks)
