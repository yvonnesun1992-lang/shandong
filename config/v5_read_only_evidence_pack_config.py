...
def get_read_only_evidence_pack_provider() -> str:
    provider = os.getenv("SHANDONG_V5_READ_ONLY_EVIDENCE_PACK_PROVIDER")
    if not provider:
        try:
...
def get_read_only_evidence_pack_status() -> dict:
    ...
    requested_flags = {
        ...
        "SHANDONG_V5_ENABLE_READ_ONLY_CONNECTOR": "read-only connector requested but blocked in V5.37",
        "SHANDONG_V5_ENABLE_SANDBOX_API": "sandbox api requested but blocked in V5.37",
        "SHANDONG_V5_ENABLE_SECRET_READ": "secret read requested but blocked in V5.37",
        "SHANDONG_V5_ENABLE_ACCOUNT_READ": "account read requested but blocked in V5.37",
        "SHANDONG_V5_ENABLE_POSITION_READ": "position read requested but blocked in V5.37",
        "SHANDONG_V5_ENABLE_BALANCE_READ": "balance read requested but blocked in V5.37",
        "SHANDONG_V5_ENABLE_ORDER_PREVIEW": "order preview requested but blocked in V5.37",
        "SHANDONG_V5_ENABLE_ORDER_SUBMISSION": "order submission requested but blocked in V5.37",
        "SHANDONG_V5_ENABLE_REAL_MONEY": "real money requested but blocked in V5.37",
    }
    ...
    return {
        "version": "V5.37",
        "read_only_evidence_pack_mode": get_read_only_evidence_pack_mode(),
